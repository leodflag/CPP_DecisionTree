...
//		}
//	}	
//	for(int j=0;j<data_row;j++){   //這個是對的!!!!!! 
//		for(int i=0;i<data_col;i++){
//			cout<<"make_goal_data，"<<Data[i][j]<<endl;
//		}
//	}
//	return Data;
//}
...
//----------找尋目標欄位Gain值----------
DecisionTree findgoalS(Data_Str data2,string *array,int c){ // 尋找不重複的，存入struct goalData，回傳字串陣列
	//---------計算行內不同屬性的Y/N個數-----------
...
////	// 做小表 
	...
	for(int i=1;i<4;i++){
		data2=make_goal_data(goalArray[i],MaxNode.col);  //要改 	
